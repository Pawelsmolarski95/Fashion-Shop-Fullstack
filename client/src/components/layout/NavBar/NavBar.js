  ...
  return (
    <div className="bg-[#f3f4f6]">
      <Popover className="mx-auto w-full flex items-center  px-6 py-2 h-24">
        ...
        <div className="grow">
          <ul className="hidden md:flex items-center font-semibold tracking-widest  text-md justify-center md:justify-end text-gray-900 gap-2 lg:gap-8 cursor-pointer">
            <a href="/">
              <li
                className=" relative transition-all w-min-content 
          before:w-0 before:h-[2px] before:absolute before:top-7 before:right-0 before:bg-[#4f46e5] before:transition-all before:duration-500
          hover:before:w-full hover:before:left-0 hover:before:bg-[#4f46e5] "
              >
                Home
              </li>
            </a>
            <ul
              className="relative flex justify-center items-center  transition-all w-min-content 
          before:w-0 before:h-[2px] before:absolute before:top-7 before:right-0 before:bg-[#4f46e5] before:transition-all before:duration-500
          hover:before:w-full hover:before:left-0 hover:before:bg-[#4f46e5]  "
            >
              Categories
